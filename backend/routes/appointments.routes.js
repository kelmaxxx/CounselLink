...
import { acceptAppointment, rejectAppointment, rescheduleAppointment, completeAppointment, removeNoShows, deleteAppointment } from "../controllers/appointments.actions.js";
...
router.delete("/:id", requireRole("student"), deleteAppointment);
